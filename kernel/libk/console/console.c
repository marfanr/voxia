...
char *
val_to_str (uint64_t val, int base)
{
    if (val == 0)
        {
            return "0";
                        ...
                        case 'b':
                            {
                                ...
                                while (*str != '\0')
                                    {
                                        fb_put_char (*str++, pos_x, pos_y,
                                                     fgcolor, FB_COLOR_BLACK);
                                        pos_x += 1;
                                    }
                                break;
                            }
...
void
console_chfg (uint32_t color)
{
    fgcolor = color;
}

void
console_add_space (int n)
{
    pos_x += n;
}
