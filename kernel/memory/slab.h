...
struct slab_cache
{
    ...
    uintptr_t phys_addr;         // Physical address of the cache (needed for destroying)
    uintptr_t current_virt_addr; // Virtual address of the cache
    boolean_t default_virt_addr;
};

// Create a new slab cache
void slab_cache_create(struct slab_cache **cache, const char *name, const size_t obj_size,
...
void slab_cache_stats(struct slab_cache *cache, size_t *total_objs, size_t *used_objs,
                      size_t *free_objs);
